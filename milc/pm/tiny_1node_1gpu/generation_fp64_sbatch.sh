...
#SBATCH --perf=generic
#SBATCH -o /global/homes/r/ruiliu/perf-model-dcgm/milc/pm/results/MILC_TINY_FP64_%j/%j.out
...
RESULTS_DIR="/global/homes/r/ruiliu/perf-model-dcgm/milc/pm/results/MILC_TINY_FP64_${SLURM_JOBID}"
mkdir -p ${RESULTS_DIR}
cd ${RESULTS_DIR}
